...
def main():
    ...
    #better_draw_circles(rg.Point(-200, 0), 22)
    #even_better_draw_circles(rg.Point(100, 50), 100, 17, 'blue', 10)
    #even_better_draw_circles(rg.Point(-200, 0), 50, 8, 'green', 30)
    even_better_draw_circles(rg.Point(0, 0), 5, 100, 'red', 7)
    even_better_draw_circles(rg.Point(0, 0), 10, 30, 'purple', 1)
...
def even_better_draw_circles(point, radi, numb, color, thick):
    ...
    for k in range(1, numb):  # k becomes 1, 2, 3, ... 10
